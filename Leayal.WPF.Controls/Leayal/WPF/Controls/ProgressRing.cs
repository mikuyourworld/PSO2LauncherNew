...
namespace Leayal.WPF.Controls
{
    ...
    public class ProgressRing : Control
    {
        ...
        public readonly static DependencyProperty EllipseDiameterScaleProperty;
        ...
        static ProgressRing()
        {
            ...
            ProgressRing.IsActiveProperty = DependencyProperty.Register("IsActive", typeof(bool), typeof(ProgressRing), new PropertyMetadata(true, new PropertyChangedCallback(ProgressRing.IsActiveChanged)));
            ...
            ProgressRing.EllipseDiameterScaleProperty = DependencyProperty.Register("EllipseDiameterScale", typeof(double), typeof(ProgressRing), new PropertyMetadata((object)1));
